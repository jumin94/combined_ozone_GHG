...
TW = {'Year': anos,models[0]:dic_ta[models[0]],models[1]:dic_ta[models[1]],
    ...
    models[24]:dic_ta[models[24]],models[25]:dic_ta[models[25]],
    models[26]:dic_ta[models[26]],models[27]:dic_ta[models[27]],
    models[28]:dic_ta[models[28]]}

TW = pd.DataFrame(TW)
TW.insert(0,"Years", anos,True)
TW.to_csv('/home/julia.mindlin/Trabajo/CMIP6_ozone/TW_timeseries_all_models.csv', float_format='%g')
...
anos = np.append(years,years_futuro)
GW = {'Year': anos,models[0]:dic_tas[models[0]],models[1]:dic_tas[models[1]],
    models[2]:dic_tas[models[2]],models[3]:dic_tas[models[3]],
    models[4]:dic_tas[models[4]],models[5]:dic_tas[models[5]],
    models[6]:dic_tas[models[6]],models[7]:dic_tas[models[7]],
    models[8]:dic_tas[models[8]],models[9]:dic_tas[models[9]],
    models[10]:dic_tas[models[10]],models[11]:dic_tas[models[11]],
    models[12]:dic_tas[models[12]],models[13]:dic_tas[models[13]],
    models[14]:dic_tas[models[14]],models[15]:dic_tas[models[15]],
    models[16]:dic_tas[models[16]],models[17]:dic_tas[models[17]],
    models[18]:dic_tas[models[18]],models[19]:dic_tas[models[19]],
    models[20]:dic_tas[models[20]],models[21]:dic_tas[models[21]],
    models[22]:dic_tas[models[22]],models[23]:dic_tas[models[23]],
    models[24]:dic_tas[models[24]],models[25]:dic_tas[models[25]],
    models[26]:dic_tas[models[26]],models[27]:dic_tas[models[27]],
    models[28]:dic_tas[models[28]]}

GW = pd.DataFrame(GW)
GW.insert(0,"Years", anos,True)
GW.to_csv('/home/julia.mindlin/Trabajo/CMIP6_ozone/GW_timeseries_all_models.csv', float_format='%g')
